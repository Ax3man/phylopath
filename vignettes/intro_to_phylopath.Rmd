...
The ranking of the models obtained here is identical as the worked example in the book chapter. The estimates differ slightly however, since we are using `phylolm` whereas the chapter was using `caper::pgls`. (Also there is one or two small mistakes in the book chapter analysis.)
