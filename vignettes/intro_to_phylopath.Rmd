...
This package follows the general approach to phylogenetic methods as used by the package `ape` (and this package with `nlme::gls` is also used "under the hood"). This means in particular that you line up your phylogenetic tree and data by assigning the tip labels as the row names of your data.frame. (Please note that this is different from the approach of `caper::pgls` where you create a comparative data object.)
