...
Or we can plot all of the models at once (this uses the `ggraph` package):

```{r, fig.height=7, fig.width=7, dpi = 90}
plot_model_set(models, text_size = 3, edge_width = 1, box_x = 6, box_y = 6)
```
