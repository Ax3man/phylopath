...
```{r, include = FALSE}
knitr::opts_chunk$set(dev = "png", out.width = "400px", out.height = "400px")
```
...
The result we end up with is a `phylo_path` object. Simply printing it gives us a table with statistics for all the models, and a plot will appear with the _average_ model.
